-- CREATE DATABASE azerbaijan DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;

-- USE azerbaijan; 

-- CREATE TABLE regions(
--     region_id INT(4) UNSIGNED AUTO_INCREMENT PRIMARY KEY, 
...
-- SELECT * FROM administrative_divisions LIMIT 10;
